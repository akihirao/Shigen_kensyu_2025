- [解析環境の設定](#解析環境の設定)
- [海面水温時系列データの読み込み](#海面水温時系列データの読み込み)
- [tsオブジェクトの内容の確認](#tsオブジェクトの内容の確認)
- [SSTの時系列折れ線グラフ](#sstの時系列折れ線グラフ)
- [SST偏差系列の作成](#sst偏差系列の作成)
- [月平均SSTのプロット](#月平均sstのプロット)
- [SST偏差系列のプロット：autoplot](#sst偏差系列のプロットautoplot)
- [SST偏差系列のプロット: ggplot](#sst偏差系列のプロット-ggplot)
- [線形ガウス状態空間モデルの定義（外生変数なしモデル：Model
  0）](#線形ガウス状態空間モデルの定義外生変数なしモデルmodel-0)
- [M0モデル関数の適用](#m0モデル関数の適用)
- [M0モデルの推定結果の確認](#m0モデルの推定結果の確認)
- [M0モデルの残差のチェック](#m0モデルの残差のチェック)
- [水準変動とその95%信頼区間の図示](#水準変動とその95信頼区間の図示)
- [ドリフト成分とその95%信頼区間の図示](#ドリフト成分とその95信頼区間の図示)
- [予測 ———————————————————————-](#予測--)
- [=============================================================================================](#section)
- [欠損データの解析 ———————————————————————-](#欠損データの解析--)
- [M0モデルの適用](#m0モデルの適用)
...
- [外生変数組み込みモデルの解析
  —————————————————————-](#外生変数組み込みモデルの解析--)
- [黒潮続流北限緯度データの読み込み](#黒潮続流北限緯度データの読み込み)
- [https://ocean.fra.go.jp/temp/O-K.html](#httpsocean.fra.go.jptempo-k.html)
- [本データの2次利用配布は不可とさせていただきます。](#本データの2次利用配布は不可とさせていただきます)
- [SSTの時系列折れ線グラフ](#sstの時系列折れ線グラフ-1)
- [線形ガウス状態空間モデル(外生変数あり:
  M1）](#線形ガウス状態空間モデル外生変数あり-m1)
- [モデル関数の適用](#モデル関数の適用)
- [推定結果の確認](#推定結果の確認)
- [モデル評価：残差のチェック](#モデル評価残差のチェック)
- [水準変動の信頼区間の図示](#水準変動の信頼区間の図示)
- [ドリフト成分の図示](#ドリフト成分の図示)
- [水準のモデル間比較](#水準のモデル間比較)
- [ドリフト成分のモデル間比較](#ドリフト成分のモデル間比較)
- [AICによるモデルの比較：M0 vs. M1](#aicによるモデルの比較m0-vs.-m1)
- [交差検証によるモデルの比較：M0
  vs. M1](#交差検証によるモデルの比較m0-vs.-m1)
- [Rスクリプトの出力](#rスクリプトの出力)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-4-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-7-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-8-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-11-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-12-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-13-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-14-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-16-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-17-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-19-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-22-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-23-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-24-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-25-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-26-1.png)
...
![](SST_ts_analyses_files/figure-markdown_github/unnamed-chunk-27-1.png)
...
```
    ...
    ##                ME     RMSE      MAE      MPE     MAPE     ACF1 Theil's U
    ## Test set 1.550861 2.106781 1.810936 7.560307 9.600264 0.772565  0.873435
