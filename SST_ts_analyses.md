...
### 本数値データ(ダウングレード加工済み)は資源評価研修の教材として、水産資源研究所海洋環境部の使用許可を受けたものです。

### !3次配布は不可でお願いします!

<figure>
<img src="https://ocean.fra.go.jp/temp/data/wm/kuroshio_2023.png"
alt="黒潮続流北限緯度" />
<figcaption aria-hidden="true">黒潮続流北限緯度</figcaption>
</figure>
